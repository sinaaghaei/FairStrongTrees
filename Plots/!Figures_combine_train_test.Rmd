...
data= read.csv('./../Results/Dec 29/FlowOCT Kamiran_version/Kamiran_default.csv', header=TRUE, sep=',', na.strings="", stringsAsFactors =TRUE) 
data_name = 'default'
...
data= read.csv('./../Results/Kamiran/default.csv', header=TRUE, sep=',', na.strings="", stringsAsFactors =TRUE) 
