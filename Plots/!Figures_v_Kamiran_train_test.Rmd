...
data= read.csv('./../Results/FlowOCT Kamiran_version Nov 22/adult 5000/adult_kamiran_5000.csv', header=TRUE, sep=',', na.strings="", stringsAsFactors =TRUE) 
...
```{r echo=TRUE, warning=FALSE}
g1 <- ggplot(data = subset(tmp,tmp$depth ==2),aes(x=(abs(disc))*100, y=acc*100)) +
