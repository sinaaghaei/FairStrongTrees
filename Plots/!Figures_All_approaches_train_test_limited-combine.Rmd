...
data= read.csv('./../Results/Dec 29/FlowOCT Kamiran_version/Kamiran_compas.csv', header=FALSE, sep=',', na.strings="", stringsAsFactors =TRUE) 
data_name = 'compas-limited-850'
...
data= read.csv('./../Results/Dec 29/FlowOCT Kamiran_version/Kamiran_compas-limited-850.csv', header=FALSE, sep=',', na.strings="", stringsAsFactors =TRUE) 
header= read.csv('./../header_kamiran.csv', header=TRUE, sep=',', na.strings="", stringsAsFactors =TRUE) 
