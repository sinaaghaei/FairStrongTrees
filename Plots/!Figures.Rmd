...
data_train_sp= read.csv('./../resupd.csv', header=TRUE, sep=',', na.strings="", stringsAsFactors =TRUE) 
data_train_csp= read.csv('./../res41.csv', header=TRUE, sep=',', na.strings="", stringsAsFactors =TRUE) 
