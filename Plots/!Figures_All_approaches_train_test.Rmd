...
data= read.csv('./../Results/EAAMO/Flow_KamiranVersion_warm (April 19)/calib 0/FlowKamiran_warm_compas_d3_calib_0.csv', header=FALSE, sep=',', na.strings="", stringsAsFactors =TRUE) 
data_name = 'compas'
...
data$approach<- factor(data$approach, levels = c("FlowOCT","DADT"))
```
