...
```{r echo=TRUE, warning=FALSE}
data= read.csv('./../Results/EAAMO/Flow_KamiranVersion_warm (April 19)/calib 1/FlowKamiran_warm_german_d6_calib-1.csv', header=FALSE, sep=',', na.strings="", stringsAsFactors =TRUE) 
data_name = 'german'
...
################################################## (IGC).Relab
data= read.csv('./../Results/Kamiran/tuning/final/igc_relab/german.csv', header=FALSE, sep=',', na.strings="", stringsAsFactors =TRUE) 
...
################################################## (IGC-IGS).Relab
data= read.csv('./../Results/Kamiran/tuning/final/igc-igs_relab/german.csv', header=FALSE, sep=',', na.strings="", stringsAsFactors =TRUE) 
header= read.csv('./../Results/Kamiran/tuning/header.csv', header=TRUE, sep=',', na.strings="", stringsAsFactors =TRUE) 
names(data) <- names(header)
rm(header)
...
################################################## (IGC+IGS).Relab
data= read.csv('./../Results/Kamiran/tuning/final/igc+igs_relab/ger', header=FALSE, sep=',', na.strings="", stringsAsFactors =TRUE) 
header= read.csv('./../Results/Kamiran/tuning/header.csv', header=TRUE, sep=',', na.strings="", stringsAsFactors =TRUE) 
names(data) <- names(header)
rm(header)
