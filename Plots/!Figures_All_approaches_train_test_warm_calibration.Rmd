...
```{r echo=TRUE, warning=FALSE}
# figure_path = "./EAAMO/calibration d6/"
# fig_name_flow = paste('cross_validation_FairOCT_',data_name,'.csv', sep = '')
# fig_name_kam_1 = paste('cross_validation_IGC_Relab_',data_name,'.csv', sep = '')
# fig_name_kam_2 = paste('cross_validation_IGC-IGS_Relab_',data_name,'.csv', sep = '')
# fig_name_kam_3 = paste('cross_validation_IGC+IGS_Relab_',data_name,'.csv', sep = '')
#   
# write.csv(data_flow, paste(figure_path,fig_name_flow,sep = ""), row.names = FALSE)
# write.csv(data_kamiran_1, paste(figure_path,fig_name_kam_1,sep = ""), row.names = FALSE)
# write.csv(data_kamiran_2, paste(figure_path,fig_name_kam_2,sep = ""), row.names = FALSE)
# write.csv(data_kamiran_3, paste(figure_path,fig_name_kam_3,sep = ""), row.names = FALSE)
```
