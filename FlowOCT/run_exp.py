                ...
                for l in [0]:
                        for fairness_type_bound in [('SP',0.1)]:#('None',1),('SP',0.1),('CSP',0.1),('PE',0.1),('EOpp',0.1),('EOdds',0.1)
                                FlowOCTReplication.main(["--train_file_reg", train_file_reg,"--train_file_enc", train_file_enc,
                                                         ...
                                                         "--protected_feature", dataset_dict[(data_set,'protected_feature')], "--positive_class", dataset_dict[(data_set,'positive_class')],"--conditional_feature", dataset_dict[(data_set,'conditional_feature')],
                                                         "--calibration_mode", calibration_mode, "--sample", 1])
