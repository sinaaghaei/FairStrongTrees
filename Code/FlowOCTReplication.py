...
def main(argv):
    ...
    primal = FlowOCT(data_train_enc, data_train_reg, label, tree, _lambda, time_limit, fairness_type, fairness_bound, protected_feature)
    ...
    with open(out_put_path + result_file, mode='a') as results:
        ...
        results_writer.writerow(
            [approach_name, input_file_enc, train_len, depth, _lambda, time_limit,
