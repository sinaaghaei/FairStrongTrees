...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(argv,'a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:',
                                   ...
                                   "test_file_reg=", "test_file_enc=",
                                    ...
                                    'positive_class=', "conditional_feature=","calibration_mode=","sample=","deprived="])
    ...
    primal = FlowOCT(data_train_enc, data_train_reg, label, tree, _lambda, time_limit, fairness_type, fairness_bound, protected_feature, positive_class, deprived_group)
